...
static int huaxing_nt36672c_on(struct huaxing_nt36672c *ctx)
{
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xee, 0x60);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xef, 0x06);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x20, 0xc0);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xdd, 0x02);
...
MODULE_DESCRIPTION("DRM driver for xiaomi 42 02 0b video mode dsc dsi panel");
MODULE_LICENSE("GPL");
